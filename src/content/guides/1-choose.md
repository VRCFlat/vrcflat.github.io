    ...
    <div class="step-content">
      ...
      <div class="step-option">
        ...
        <div class="option-decision-box">
          ...
          <p class="option-text desc">¥2,000と最もリーズナブル！服は着ていませんが、BOOTH等で配布・販売されている数多くの衣装を着せ替えて楽しむことができます！（※値段改定に伴い公式サポートは終了しています）</p>
        </div>
      </div>
    </div>
  </div>
...
| 種類 | BS値 | 着用している服 | 公式サポート |
|---|---|---|---|
| **無印** | 40 | なし | 終了（¥2,000に改定） |
| **2nd** | 42 | パーカー | 終了（¥2,000に改定） |
| **4th** | 64 | テックウェア | ○ |
| **IF** | 56 | ストリートウェア | ○ |

> [!NOTE]
> **無印・2ndは公式サポートが終了しています**
> 値段改定（¥2,000）に伴い、作者様によるアバターに関する質問対応などのサポートは終了しています。お安く購入できるようになった一方で、困ったときは自力（またはコミュニティ）での解決が基本になります。
